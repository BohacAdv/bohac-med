...
export default function EquaracaoPage() {
      ...
      <footer className="footer">
        <div className="wrap">
          <div className="footer__top">
            ...
            <div className="footer__col">
              <h4>Contato</h4>
              <a href="https://wa.me/5518996205555" target="_blank" rel="noopener">
                (18) 99620-5555
              </a>
          ...
          <div className="footer__bottom">
            ...
            <div className="footer__social">
              <a href="https://instagram.com/bohacadvogados" target="_blank" rel="noopener" aria-label="Instagram">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="https://linkedin.com/company/bohacadvogados" target="_blank" rel="noopener" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
